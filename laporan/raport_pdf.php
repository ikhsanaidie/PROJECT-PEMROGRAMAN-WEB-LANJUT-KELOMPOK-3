...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .kop h1 { font-size: 20px; letter-spacing: 3px; }
        .kop p { font-size: 12px; color: #333; }
        .kop h2 { font-size: 15px; margin-top: 5px; }
        .info { margin-bottom: 15px; }
        .info table { width: 70%; font-size: 11px; }
        .info td { padding: 3px 5px; }
        .info .label { width: 120px; font-weight: bold; }
        table.nilai { width: 100%; border-collapse: collapse; font-size: 10px; }
        table.nilai th { background: #1976D2; color: white; padding: 5px 4px; border: 1px solid #000; text-align: center; }
        table.nilai td { padding: 4px; border: 1px solid #000; text-align: center; }
        table.nilai .left { text-align: left; padding-left: 8px; }
        .ttd { margin-top: 40px; }
        .ttd table { width: 100%; }
        .ttd td { text-align: center; padding: 5px; }
        .ttd .line { border-bottom: 1px solid #000; width: 80%; margin: 10px auto 5px; }
        .footer { margin-top: 20px; text-align: center; font-size: 9px; color: #666; border-top: 1px solid #ccc; padding-top: 10px; }
        .catatan { margin: 15px 0; font-style: italic; font-size: 11px; padding: 10px; background: #f9f9f9; border-radius: 5px; }
        .rata { font-weight: bold; background: #f0f0f0; }
        .absensi-box { display: inline-block; padding: 5px 12px; margin: 2px; border-radius: 4px; font-size: 11px; }
        .absensi-sakit { background: #ffeb3b; }
        .absensi-izin { background: #2196f3; color: white; }
        .absensi-alpa { background: #f44336; color: white; }
...
<body>
    ...
    <div class="info">
        <table>
            <tr><td class="label">Nama Siswa</td><td>: <?php echo $data_siswa['nama']; ?></td></tr>
            <tr><td class="label">NISN</td><td>: <?php echo $data_siswa['nisn']; ?></td></tr>
            <tr><td class="label">Kelas</td><td>: <?php echo $data_siswa['kelas']; ?></td></tr>
            <tr><td class="label">Wali Kelas</td><td>: <?php echo $waliKelas; ?></td></tr>
            <tr><td class="label">Semester</td><td>: <?php echo $semester; ?></td></tr>
            <tr><td class="label">Tahun Ajaran</td><td>: <?php echo $tahun; ?></td></tr>
        </table>
    </div>
    ...
    <table class="nilai">
        ...
        <tbody>
            ...
            <?php endwhile; ?>
            <?php if ($count == 0): ?>
            <tr><td colspan="8" style="text-align:center;padding:20px;">Belum ada data nilai</td></tr>
            <?php else: ?>
            <tr class="rata">
